...
<template>
  <section id="evaluations" class="evaluation-center">
    <div class="evaluation-heading">
      ...
      <div class="evaluation-summary"><span><strong>{{ cases.length }}</strong> 标准用例</span><span><strong>{{ completedEvaluations }}</strong> 历史版本</span></div>
    </div>
